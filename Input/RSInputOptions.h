...
static inline BOOL RSInputValidEngines(id engines) {
    ...
    for (id item in engines) {
        if (![item isKindOfClass:NSDictionary.class] || ![item[@"name"] isKindOfClass:NSString.class] ||
            ![item[@"name"] length] || [item[@"name"] length] > 30 || !RSInputSearchURL(item[@"engine"], @"测试 &/?")) return NO;
    }
    return YES;
}
static inline NSArray *RSInputSearchEngines(NSDictionary *config) {
    return RSInputValidEngines(config[@"searchEngines"]) ? config[@"searchEngines"] :
        @[@{@"name": @"百度", @"engine": @"https://www.baidu.com/s?wd=%@"},
          @{@"name": @"Google", @"engine": @"https://www.google.com/search?q=%@"}];
}
static inline NSDictionary *RSInputPromptOptions(NSDictionary *config) {
    NSMutableDictionary *result = [@{@"enabled": @YES, @"size": @100, @"height": @50, @"duration": @3,
        ...
        @"tokenWindowPriority": @1000000000, @"aiWindowPriority": @1000000000, @"panelPosition": @1, @"panelHeight": @0, @"panelTop": @8} mutableCopy];
    ...
    NSDictionary *ranges = @{@"size": @[@60, @160], @"height": @[@10, @90], @"duration": @[@0.5, @3], @"animationSpeed": @[@0.5, @2],
        ...
        @"tokenWindowPriority": @[@0, @1000000000], @"aiWindowPriority": @[@0, @1000000000], @"panelPosition": @[@0, @2], @"panelHeight": @[@0, @1000], @"panelTop": @[@0, @300]};
